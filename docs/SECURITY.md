...
| 版本 | 支持状态 | EOL |
|------|---------|-----|
| v1.5.0 (master) | ✅ 积极支持 | TBD |
| v1.4.1-hotfix6 | ⚠️ 安全修复 backport | 2026-12-31 |
| v1.4.1-hotfix1~5 | ⚠️ 安全修复 backport | 2026-12-31 |
| v1.4.0 | ⚠️ 关键安全修复 | 2026-12-31 |
| v1.3.4 | 🟡 仅关键 CVE | 已 EOL |
